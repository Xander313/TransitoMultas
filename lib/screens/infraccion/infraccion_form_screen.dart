    ...
    try {
      if (item == null) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('Tipo de infracción creado')));
      } else {
        await repository.update(nuevo);
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('Tipo de infracción actualizado')));
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          viewOnly
              ? "Ver Tipo de Infracción"
              : esEditar
              ? "Editar Tipo de Infracción"
        ...
        child: ListView(
          ...
          children: [
            TextFormField(
              ...
              decoration: _decoration(label: "Código", hint: "Ej: A01, B12, C07", icon: Icons.code),
            ),
